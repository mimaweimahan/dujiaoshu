...
return [
    ...
    "clone" => "✖️关闭",
    "month" => "个月",
    "not_huiyuan_config" => "当前没有会员配置",
    'Get Fragment Error' => "Fragment获取用户信息失败",
    'Created ton order error' => '创建ton订单失败',
    'Confirmre ton order error' => '确认ton订单失败,到此步骤多半账号未认证导致',
    'Decode order data error' => '解码订单数据失败',
    'Caused by IP not being whitelisted' => 'ip未加白导致的问题',
    'yuepay' => '余额支付',
    'No_need_to_change_language' => '无需改变语言',
    "Order_list_null" => "订单列表为空",
    "yue" => "余额",
];
