        ...
        <div class="col-lg-4">
            <div class="card card-body sticky">
                <form id="login" action="{{ url('login') }}" method="post">
                    ...
                    <div class="mt-4 text-center">
                        <script async src="https://telegram.org/js/telegram-widget.js?22" data-telegram-login="{{ dujiaoka_config_get('telegram_bot_username') }}" data-size="large" data-auth-url="/logintg" data-request-access="write"></script>
                    </div>
                </form>
