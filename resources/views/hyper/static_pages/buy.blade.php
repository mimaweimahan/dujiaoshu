...
@endif
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control" value="{{Auth::user()->email?Auth::user()->email:Auth::user()->telegram_id}}" disabled>
                    @else
        ...
        $.ajax({
            ...
            success: function(data) {
                initGeetest({
                    ...
                    lang: '{{ dujiaoka_config_get('language') ?? 'zh-CN' }}',
